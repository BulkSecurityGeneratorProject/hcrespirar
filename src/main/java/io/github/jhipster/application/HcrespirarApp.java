...
public class HcrespirarApp {

    private static final Logger log = LoggerFactory.getLogger(HcrespirarApp.class);

    private final Environment env;

    public HcrespirarApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes hcrespirar.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(HcrespirarApp.class);
